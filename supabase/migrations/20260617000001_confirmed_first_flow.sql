-- ============================================================================
-- 承認制（仮確定→本確定）の廃止。オーナー意向により即確定フローに戻す。
--
--   「何かあった場合は店舗からお客様に連絡すればよいので仮予約は不要」
--   とのことなので、Web からの新規予約は従来どおり confirmed で登録する。
--
-- 20260616000001_pending_first_flow.sql を打ち消すマイグレーション。
-- （20260616000001 を未実行のまま本ファイルを実行しても問題ない・冪等）
-- ============================================================================
